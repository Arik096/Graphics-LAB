   ...
   // glTranslatef(tx,0,0); //animate
    ...
    glPushMatrix();

        {
                    ...
                    glPushMatrix(); ///obstacle1
                {

                    glScalef(2,1.2,1.8);
                    glColor3f(01, 1, 1);
                    glTranslatef(-320,100,80);
                    drawCube(30);

                }glPopMatrix();

                glPushMatrix(); ///obstacle4
                {

                    glScalef(2,1.2,1.8);
                    glTranslatef(190,80,-80);
                    glColor3f(01, 1, 1);
                    drawCube(30);

                }glPopMatrix();

                glPushMatrix(); ///obstacle2
                {

                    glScalef(2,1.2,1.8);
                    glTranslatef(-170,80,-70);
                    glColor3f(01, 1, 1);
                    drawCube(30);

                }glPopMatrix();

                glPushMatrix(); ///obstacle3
                {

                    glScalef(2,1.2,1.8);
                    glTranslatef(0,80,80);
                    glColor3f(01, 1, 1);
                    drawCube(30);
...
void display(){
	...
	********************/
    ...
    //gluLookAt(00,00,200,	0,0,0,	0,0,0);
	gluLookAt(-100,200,0,	0,200,0,	0,1,0);
	//gluLookAt(500,500,500,	0,0,0,	0,0,0);
